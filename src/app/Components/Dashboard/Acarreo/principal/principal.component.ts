...
import { VolquetesService } from '../../../../services/volquetes.service';
import { ExcelExportVolquetesService } from '../../../../services/export/excel-export-volquetes.service';
...
export class PrincipalComponentVolquetes implements OnInit {

  datosOperaciones: Volquetes[] = [];
  datosOperacionesExport: Volquetes[] = [];
  datosOperacionesOriginal: Volquetes[] = [];
  ...
  constructor(
    private excelExportVolquetesservice: ExcelExportVolquetesService,
    private VolquetesServis: VolquetesService
  ) {}
...
this.construirGanttData(this.datosOperaciones);
  ...
  // ======================================================
  obtenerDatos(): void {
    this.VolquetesServis.getAll().subscribe({
      next: (data: Volquetes[]) => {
  ...
  // ======================================================
  exportToExcel() {
    this.excelExportVolquetesservice.exportToExcel(
  ...
  exportToExcelFiltro() {
    ...
    private construirGanttData(datos: Volquetes[]) {
